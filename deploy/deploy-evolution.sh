...
echo -e "   Evolution API:     ${GREEN}https://wa.ytem.com.br${NC}"
echo -e "   Evolution Manager: ${GREEN}https://wa-manager.ytem.com.br${NC}"
echo ""
echo -e "${YELLOW}📝 Próximos passos:${NC}"
echo -e "   1. Aguardar SSL ser gerado (~1 minuto)"
echo -e "   2. Acessar: ${GREEN}https://wa.ytem.com.br/instance/connect/meu-zap${NC}"
echo -e "   3. Escanear QR Code com WhatsApp"
echo -e "   4. Configurar webhook: ${GREEN}https://stickers.ytem.com.br/webhook${NC}"
echo ""
